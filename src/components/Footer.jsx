  ...
  return (
    <footer className="bg-black text-gray-400 mt-20 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Premium streetwear & luxury fashion clothing brand. Quality guaranteed.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/shop?category=Men" className="hover:text-white">Men Collection</Link></li>
            <li><Link to="/shop?category=Women" className="hover:text-white">Women Collection</Link></li>
        ...
        <div>
          ...
          <p className="text-sm mb-3">Subscribe for secret drops and offer updates.</p>
          <div className="flex">
            <input 
              type="email" 
              placeholder="Your email address" 
              className="bg-gray-900 border border-gray-800 text-white text-sm rounded-l px-3 py-2 w-full focus:outline-none focus:border-red-600"
            />
            <button className="bg-red-600 text-white font-medium text-sm px-4 rounded-r hover:bg-red-700 transition-colors">
              Join
            </button>
          </div>
        </div>
      ...
      <div className="border-t border-gray-900 py-6 text-center text-xs text-gray-500 flex flex-col sm:flex-row items-center justify-between max-w-7xl mx-auto px-4">
        <p>© 2026 MOHSIN.FIT Clothing Brand. All rights reserved.</p>
